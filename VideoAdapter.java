...
public class VideoAdapter extends SimpleCursorAdapter {
	...
	// THIS FUNCTION will give the details of the file like display name, title,
	// duration
	...
	// Retrieved data from the returned cursor is retrieved here and is set in
	...
	// This function is responsible for seting the UI for Custom list as
	// activity_musiclist is attached here.
	@Override
